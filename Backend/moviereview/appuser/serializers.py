...
from .models import User, Admin, Movie, Serie, CommentMovie, CommentSerie, FavoriteMovie, FavoriteSerie, ScoreSerie, ScoreMovie
...
class ScoreMovieSerializer(serializers.ModelSerializer):
    class Meta:
        model = ScoreMovie
        fields = '__all__'
