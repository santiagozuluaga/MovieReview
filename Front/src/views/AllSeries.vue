<template>
  <div class="container-allseries">
    ...
    <b-container>
      ...
      <b-row>
        <b-col col="6" class="container-serie text-center" v-bind:key="serie.id" v-for="serie in Series">
          <div class="container-serie-img" v-on:click="seeSerie(serie.id)">
            <b-img-lazy rounded width="180" v-bind:src="baseUrl+serie.poster_path"></b-img-lazy>
            <div class="title-img">
              <span><strong>{{serie.original_name}}</strong></span>
            </div>
          </div>
        </b-col>
      </b-row>
